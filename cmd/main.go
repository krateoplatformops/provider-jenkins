...
import (
	...
	"github.com/krateoplatformops/provider-jenkins/apis"
	"github.com/krateoplatformops/provider-jenkins/internal/controllers"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Jenkins support for Crossplane.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-jenkins"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID:           "leader-election-provider-jenkins",
